...
%% Postprocessing
box on, grid on
legend('BSmag, z = 0 mm','BSmag, z = 1 mm','BSmag, z = 5 mm','Analytical, z = 0 mm','Analytical, z = 1 mm','Analytical, z = 5 mm'), legend('boxoff')